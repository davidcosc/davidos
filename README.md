...
The code to our first boot sector can be found in "./tutorials/01-basics.asm". To make the most of it, the code is commented extensively. For a more general explanaition of NASM assembly code structure it might be worth having a look at [chapter 2](#2-instruction-operands-optional) first.
